...
package StackPkg is
	...
	--Added a length function to this, needed it for something.
	
	function length (s:Stack) return Integer; 


private
    MaxSize : Constant Natural := 1000; --You said not to modify the specification but I didn't know how else to do isFull.
	
	type StackElements is array(1 .. Size) of ItemType;

	type Stack is record
		Elements : StackElements;
        Top : Natural range 0 .. MaxSize := 0;
	end record;
